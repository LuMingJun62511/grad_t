...
HUAWEI_ENTITIES = {
    "products": [
        "Mate 70", "Mate 70 Pro", "Mate 70 Pro+", "Mate 60", "Mate 60 Pro",
        "Mate XT", "Mate XT 非凡大师", "Mate X5", "Mate X3",
        "Pura 80", "Pura 80 Ultra", "Pura 70", "Pura 70 Pro",
        "nova 13", "nova Flip",
        "麒麟9000S", "麒麟9010", "麒麟9020", "麒麟芯片",
        "鸿蒙OS", "鸿蒙NEXT", "鸿蒙4.0", "鸿蒙5.0", "鸿蒙系统",
        "问界M9", "问界M7", "问界M5", "智界S7", "享界S9",
        "MatePad Pro", "MatePad Air",
        "MateBook X Pro", "MateBook 16",
        "FreeBuds Pro 4", "FreeClip",
        "华为Watch GT 5", "华为Watch Ultimate",
        "华为全家桶",
    ],
    "people": [
        "余承东", "余总", "任正非", "任总",
    ...
    "pain_points": [
        ...
        "售后响应慢", "客服排队久", "系统更新跳票",
        "价格高/降价背刺", "微信适配慢", "应用生态不足",
        "黄牛加价", "饥饿营销", "发布会PPT夸大",
        "多设备协同不稳定", "折叠屏折痕",
    ],
    "competitors": [
        "苹果", "iPhone", "小米", "OPPO", "vivo", "三星",
        "特斯拉", "理想", "蔚来", "小鹏", "比亚迪",
    ],
}
...
def build_generation_prompt(category_label: str, count: int,
    ...
    prompt_parts.append(f"- 产品：{', '.join(HUAWEI_ENTITIES['products'][:15])}...")
